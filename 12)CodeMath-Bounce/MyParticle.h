...
public:
    ...
    MyParticle() {}
    MyParticle(float x, float y, float speed, float direction, float mass = 1, float gravity = 0, float radius = 0, float bounce = -1);
    ~MyParticle() {}
    //getters---------------------------------------------
    ...
    //setters------------------------------------------------------
    void SetAll(float x, float y, float speed, float direction, float mass, float gravity, float radius, float bounce);
